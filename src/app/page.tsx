...
export default function Home() {
	return (
		<div className="flex flex-col justify-center items-center w-full h-full text-center">
			<section className="gap-8 grid grid-cols-1 md:grid-cols-[2fr_1fr] mb-12">
				<div className="flex flex-col items-start gap-4 text-start">
					<h1 className="font-medium text-5xl xl:text-6xl">
						Hi, <br />
						I'm{" "}
					...
					<p className="mt-3 font-semibold text-muted-foreground text-xl tracking-tight">
				...
				<div className="relative flex flex-col items-start gap-8 w-full text-start">
			...
			<div className="right-0 bottom-12 left-0 absolute flex mx-auto w-full">
				<div className="flex flex-col justify-end items-start gap-3 mx-auto container">
					<Button
						variant="ghost"
			...
			<div className="top-1/2 left-1/2 -z-1 absolute w-[320px] sm:w-[420px] md:w-[560px] lg:w-[620px] xl:w-[680px] h-[320px] sm:h-[420px] md:h-[560px] lg:h-[620px] xl:h-[680px] -translate-x-1/2 -translate-y-1/2 transform">
				<Image
